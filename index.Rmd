---
title: "WolfWorks: Reproducible Research with R"
output: 
  html_document:
    toc: FALSE
---
...
Attendees are expected to have *some* previous experience with coding in R as the
basics of the R language and using RStudio will not be covered in this workshop.
...
```{r, echo = FALSE}
tabl1 <- data.frame("Session" = c("Morning", "Morning",
                                  "Morning", "Morning and Afternoon", "Afternoon"),
                    "Topic" = c("A summary of R and RStudio", 
                                "Projects in RStudio", 
                                "R Markdown Basics",
                                "Advanced R Markdown",
